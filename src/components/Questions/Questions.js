...
const Questions = ({ BsBoxArrowUpRight }) => {
    return (
        <div className='mx-5 my-5'>
            <Accordion>
                <Accordion.Item eventKey="0">
                    <Accordion.Header><BsBoxArrowUpRight className='me-2' />How React Works?</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header><BsBoxArrowUpRight className='me-2' />Difference between Props vs State? </Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header><BsBoxArrowUpRight className='me-2' />How React Use States Works? </Accordion.Header>
                    <Accordion.Body>
